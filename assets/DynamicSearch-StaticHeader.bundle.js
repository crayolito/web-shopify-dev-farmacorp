...
var eventemitter2 = __webpack_require__(30);
...
var SearchForm = __webpack_require__(17);
 ...
 */
  ...
  function ProductPriceMain2(price) {
  return "\n  <span class=\"search-flydown--product-price--main\">\n    <span class=\"money\">".concat(price.compare_at_price, "</span>\n  </span>\n  ");
}

function ProductPriceAnt(props) {
...
if(enable && tags.includes(tag)){
  
  var $compareAt = onSale && consistentSaved ? ProductPriceCompareAt(price) : '';
  var $price = ProductPriceMain2(price);
  return "\n  <span class=\"search-flydown--product-price ".concat($price, "\n  <span class='badge badge-danger'>"+badge+"</span>  </span>\n  ");
...
//# sourceMappingURL=DynamicSearch-StaticHeader.bundle.js.map?1585847753798