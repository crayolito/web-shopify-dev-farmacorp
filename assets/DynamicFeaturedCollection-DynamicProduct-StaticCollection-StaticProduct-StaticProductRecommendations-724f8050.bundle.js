...
var AddToCartFlyout = __webpack_require__(34);
...
var theme_a11y = __webpack_require__(19);
...
var ProductGallery_ProductGallery = /*#__PURE__*/function () {
  ...
  ProductGallery_createClass(ProductGallery, [{
    ...
    value: function _onThumbnailClick(e) {
      ...
      } else if (e.target.parentNode.parentNode.parentNode.classList.contains('product-gallery--media-thumbnail')) {
        button = e.target.parentNode.parentNode.parentNode;
      } else {
        return;
      }
...
var MessageBanner = __webpack_require__(22);
      ...
      jquery_default.a.ajax({
        ...
        */
        ...
        jquery_default.a.ajax({
          ...
          $productPriceValue.text(Shopify.formatMoney(lineItem.original_price, _this.settings.moneyFormat));
          ...
          if (lineItem.final_price < lineItem.original_price) {
            $productPriceDiscounted.text(Shopify.formatMoney(lineItem.final_price, _this.settings.moneyFormat));
...
/* harmony import */ var fitvids__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/* harmony import */ var fitvids__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fitvids__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var grouped_content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
//# sourceMappingURL=DynamicFeaturedCollection-DynamicProduct-StaticCollection-StaticProduct-StaticProductRecommendations-724f8050.bundle.js.map?1585847753798